#
#  Be sure to run `pod spec lint SimplyLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Create Auto Layout constraints in formula liked coding style.
                   DESC

  s.homepage     = "https://github.com/aipeople/SimplyLayout"
  ...
  s.source       = { :git => "https://github.com/aipeople/SimplyLayout.git", :tag => "1.1.0" }
